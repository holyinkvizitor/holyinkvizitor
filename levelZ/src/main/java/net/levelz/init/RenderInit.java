...
import net.levelz.customChange.MagicInfoScreen;
import net.levelz.customChange.MagicListScreen;
import net.levelz.customChange.MagicScreen;
...
import net.levelz.customChange.MagicTab;
...
public class RenderInit {
    ...
    public static void init() {
        ...
        TabRegistry.registerInventoryTab(new MagicTab(Text.translatable("custom.screen.levelz.skill_screen"), SKILL_TAB_ICON, 2, MagicScreen.class, MagicInfoScreen.class, MagicListScreen.class));
